...
$(function(){$("img.lazy").lazyload();});$(document).ready(function(){$("ul.aa .bb").hover(function(){$(this).addClass("hover").find("div.cc").show();},function(){$(this).removeClass("hover").find("div.cc").hide();});});
...
function setTab(name,name2,cursel,n)
   ...
   $(document).ready(function(){var qcloud={};$('[_t_nav]').hover(function(){var _nav=$(this).attr('_t_nav');clearTimeout(qcloud[_nav+'_timer']);qcloud[_nav+'_timer']=setTimeout(function(){$('[_t_nav]').each(function(){$(this)[_nav==$(this).attr('_t_nav')?'addClass':'removeClass']('nav_hover');});$('#'+_nav).stop(true,true).slideDown(0);},0);},function(){var _nav=$(this).attr('_t_nav');clearTimeout(qcloud[_nav+'_timer']);qcloud[_nav+'_timer']=setTimeout(function(){$('[_t_nav]').removeClass('nav_hover');$('#'+_nav).stop(true,true).slideUp(0);},0);});});


$(function(){for(var i=0;i<$("div[name=ee]").length;i++){var m=$("div[name=ee]").eq(i);if(m.text().length>170){m.attr("ee",m.text());m.html(m.text().substr(0,170)+"...<a name=\"zhankai\" class=\"y\" href=\"javascript:;\">展开</a>");}}
$("a[name=zhankai]").on("click",function(){$(this).parent().html($(this).parent().attr("ee")+"<a name=\"yinchang\" class=\"y\" href=\"javascript:;\">隐藏</a>");});$("a[name=yinchang]").on("click",function(){$(this).parent().html($(this).parent().attr("ee").substr(0,170)+"...<a name=\"zhankai\" class=\"y\" href=\"javascript:;\">展开</a>");});});

$(function(){$(".sbtn").click(function(){if($(this).hasClass("cur"))

{$(".sbtn").removeClass("cur");$(".sy").hide();}
else{$(".sy").show();$(".sbtn").addClass("cur");}})
$(".sbtn1").click(function(){if($(this).hasClass("cur"))
{$(".sbtn1").removeClass("cur");$(".sy1").hide();}
else{$(".sy1").show();$(".sbtn1").addClass("cur");}})
$(".sbtn2").click(function(){if($(this).hasClass("cur"))
{$(".sbtn2").removeClass("cur");$(".sy2").hide();}
else{$(".sy2").show();$(".sbtn2").addClass("cur");}})});function $$(id){return document.getElementById(id);}
...
s2="<em onclick=\"Order(0,'vlink_"+vi+"',"+vi+")\">顺序↑</em>"}else{for(i=leng-1;i>=0;i--){if(i==0){isno='<li class="new">';}else{isno='<li>';}
uhtml+=isno+tag[i].innerHTML+"</li>";}
